...
def read_data1(filename):
    sys_act = []
    turn = []
    with open(filename, 'r') as d:  #TODO name of pre trg file changing not hard coded...
        for line in d:
            info = line.split(' ')
...
t, a = read_data1('_curiosity_model/pretrg_data/2018-07-05_15:15:36')
a = np.eye(16, 16)[a]  # convert to one-hot
s, _s = read_data2('_curiosity_model/pretrg_data/prev_state2018-07-05_15:15:36',
                   '_curiosity_model/pretrg_data/state2018-07-05_15:15:36')
...
loss = []
# # check if prev state vec is correct: todo: how does this hold when first prev_state is zeros but no zero states in states when i checked
# if s[:-1] == _s[1:]:
#     print 'works'

# # **********************uncomment to train pretrained model more:
...
for i in range(num_iterations):
    ...
    # saver.save(sess, '_curiosity_model/pretrg_model/trained_curiosity2')
